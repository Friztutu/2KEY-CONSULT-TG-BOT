...
MARKET_DURATIONS = {
    "1": "Меньше 6 месяцев", "2": "От 6 месяцев до года",
    "3": "От года до трех лет", "4": "Более трех лет"}
MARKET_TURNOVERS = {
    "1": "От 0 до 200,000₽", "2": "От 200,000 до 500,000₽", "3": "От 500,000 до 1,000,000₽",
    "4": "От 1,000,000 до 5,000,000₽", "5": "Более 5,000,000₽"
}
PAYMENT_METHODS = {
    "1": "Только фиксированная оплата", "2": "Фиксированная оплата + % от прибыли",
    "3": "Фиксированная оплата + % от выручки"
}
CLIENT_PROBLEMS = {
    "1": "Проблемы с ДРР", "2": "Хочу увеличить выручку", "3": "Низкая рентабельность",
...
REQUEST_CONTACT_INLINE_KEYBOARD = ReplyKeyboardMarkup(keyboard=[
    [KeyboardButton(text="Отправить свой контакт ☎️ для связи", request_contact=True)],
